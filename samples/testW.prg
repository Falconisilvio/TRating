...
Function Test()
   ...
   @ 21, 325 say oSay PROMPT "  "  SIZE 90, 26 OF  oWnd PIXEL  FONT oFont

   oRating:= TRating():New(24,205, oWnd,,,,".\bitmaps\png\empty.png" ,".\bitmaps\png\half.png", ".\bitmaps\png\full.png" )
